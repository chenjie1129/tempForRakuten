...
namespace agora {
    namespace recording {
		...
		if (str_streamType == "0") {
			config.mixResolution = "720,1280,24,3000";
			cout << "portrait mode, 720*1280" << endl;
		} else if (str_streamType == "1") {
			config.mixResolution = "1280,720,24,3000";
			...
			config.mixResolution = "1280,720,24,3000";
                ...
                out.str("");
                out << layout.canvasWidth << "," << layout.canvasHeight << ",24," << resolutionValue;
